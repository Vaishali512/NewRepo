Feature: Passion Tea Company

  Background:
   
  
  @pt
  Scenario: User Send an email to get some info
    Given User navigates to "http://www.practiceselenium.com/menu.html"
      ...
      And User enters "Venkatraman" in "Name" field
      And User enters "nv.ram82@gmail.com" in "Email" field
      And User enters "Hello" in "Subject" field
      And User enters "Need some Info" in "Message" field
  ...
  @pt1
  Scenario Outline: User Send an email to get some info
